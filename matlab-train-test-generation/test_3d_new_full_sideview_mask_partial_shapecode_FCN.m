...
%% generate original side-view1/2 fingerprint for test based FCN segmentation
for ii=1:160
    for jj=1:6
...
set(gcf,'visible','off');
print(gcf,'-dpng',['..\all_3d_full_sideview_mask_shapecode_FCN\',num2str(ii),'_',num2str(jj),'.png']) ;
% print(gcf,'-dpng',['..\all_3d_full_sideview1_mask_shapecode_FCN\',num2str(ii),'_',num2str(jj),'.png']) ;
close all;
